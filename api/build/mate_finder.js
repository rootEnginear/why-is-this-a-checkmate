...
const isAtBoardEdge = (square) => square.includes("a") ? "left" : square.includes("h") ? "right" : false;
/**
 * transpileFen
 * --------------------------------------------------
...
const calcLeftRightSpace = (square_name) => {
 ...
 * @returns
 */
const checkScan = (boardData, checkWhite = true) => (square_name) => {
    ...
    let walkTop = 1, walkLeft = 1, walkRight = 1, walkBottom = 1;
